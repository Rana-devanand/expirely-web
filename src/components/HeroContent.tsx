...
export default function HeroContent({
  ...
  return (
    ...
    >
      ...
      {/* Heading */}
      <h1 className="mb-6 text-4xl font-black leading-[1.08] tracking-tight sm:text-5xl md:text-6xl lg:text-7xl"
      ...
      {/* Description */}
      <p className="mb-10 max-w-3xl text-base leading-relaxed sm:text-lg md:text-xl"
        style={{ color: 'var(--color-text-muted)' }}>
        {description}
      </p>

      {/* Buttons */}
      <div className="flex w-full flex-col items-center justify-center gap-4 transition-all duration-300 sm:w-auto sm:flex-row">
        <Link
